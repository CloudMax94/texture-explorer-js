...
module.exports = class TexturePreview {
    ...
    set format(data) {
        ...
        if (this.inputs) {
            ...
            if (this.format.hasPalette()) {
                ...
                document.querySelector('label[for="'+this.inputs.palette.id+'"]').style.display = '';
            } else {
                this.inputs.palette.style.display = 'none';
                document.querySelector('label[for="'+this.inputs.palette.id+'"]').style.display = 'none';
            }
