...
/*
tree.getElement().addEventListener('contextmenu', function (event) {
    if (event.target.tagName == 'TREE-ITEM') {
        ...
        menu.append(new MenuItem({ label: 'New Directory', click: function() {
            var workspace = obj.workspace;
            var directory = workspace.newItem('directory');
        ...
        menu.append(new MenuItem({ label: 'New Texture', click: function() {
            var workspace = obj.workspace;
            var texture = workspace.newItem('texture');
